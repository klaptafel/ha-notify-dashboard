...
- Removed `frontend/notify-dashboard-badge.js`, a design-note stub for a badge feature that was never built or registered; had no effect on the shipped card.
